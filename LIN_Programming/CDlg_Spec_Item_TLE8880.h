...
class CDlg_Spec_Item_TLE8880 : public CPropertyPage
{
	DECLARE_DYNAMIC(CDlg_Spec_Item_TLE8880)

public:
	CDlg_Spec_Item_TLE8880();
	virtual ~CDlg_Spec_Item_TLE8880();

// Dialog Data
	enum { IDD = IDD_DIALOG_TLE8880 };
