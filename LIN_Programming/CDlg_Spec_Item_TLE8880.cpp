// CDlg_Spec_Item_TLE8880.cpp : implementation file
//
...
// CDlg_Spec_Item_TLE8880 dialog

IMPLEMENT_DYNAMIC(CDlg_Spec_Item_TLE8880, CPropertyPage)

CDlg_Spec_Item_TLE8880::CDlg_Spec_Item_TLE8880()
	: CPropertyPage(CDlg_Spec_Item_TLE8880::IDD)
{
	m_var.nPnum = 0;
}
...
void CDlg_Spec_Item_TLE8880::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlg_Spec_Item_TLE8880, CPropertyPage)
	ON_CBN_SELCHANGE(IDC_COMBO_REGULATOR, &CDlg_Spec_Item_TLE8880::OnCbnSelchangeComboRegulator)
END_MESSAGE_MAP()


// CDlg_Spec_Item_TLE8880 message handlers
BOOL CDlg_Spec_Item_TLE8880::OnInitDialog()
{
...
void CDlg_Spec_Item_TLE8880::f_Dlg_Set  (unsigned p)
{
...
//	pLin->nChip = SELECT_TLE8880;

	this->UpdateData(FALSE);
}

void CDlg_Spec_Item_TLE8880::f_Dlg_Read (unsigned p)
{
...
void CDlg_Spec_Item_TLE8880::f_Chip_Change ()
{
...
void CDlg_Spec_Item_TLE8880::OnCbnSelchangeComboRegulator()
{
...
BOOL CDlg_Spec_Item_TLE8880::OnSetActive()
{
